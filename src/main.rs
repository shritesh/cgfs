...
fn canvas_to_viewport(x: i32, y: i32) -> Vec<3> {
    Vec([
...
fn trace_ray(origin: &Vec<3>, d: &Vec<3>, t_min: f64, t_max: f64) -> Color {
...
fn intersect_ray_sphere(origin: &Vec<3>, d: &Vec<3>, sphere: &Sphere) -> (f64, f64) {
    let r = sphere.radius;
